...
import { MAINTAINENCE } from "./config/general"
...
function App() {
  ...
  return (
    <>
      ...
      {MAINTAINENCE && <div className="absolute z-10 bg-spotify-grey inset-0 flex justify-center items-center flex-col gap-4">
