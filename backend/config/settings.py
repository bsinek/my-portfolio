...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-=a5igsxgg1c4!jajj+%o0mapbv3-mv!c^11lr1i2u01-a(m)c$')
...
# old sqlite database configuration
# DATABASES = {
#     'default': {
...
# Media files (uploads)
MEDIA_URL = '/media/'
# Use environment variable for production volume mount, fallback to local
