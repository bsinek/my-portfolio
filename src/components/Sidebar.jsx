       ...
       <a href={href} className="group/item flex items-center gap-3 h-16 p-2 rounded-md hover:bg-white/5 active:bg-white/10">
            <div className="relative h-full aspect-square rounded-sm bg-white/30 group-hover/item:bg-white/10">
                <div className="absolute inset-0 p-[15px] opacity-0 group-hover/item:opacity-100">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="playbtn h-full">
            ...
            <div className="flex flex-col justify-center font-light">
                ...
                <span className="text-light-grey text-sm flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="pin-angle inline h-3 text-spotify-green mr-1">
...
const ContactItem = ({ href, label }) => {
    ...
    switch (label) {
        case "LinkedIn":
            icon = (
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="linkedin h-full" viewBox="0 0 16 16">
        ...
        case "GitHub":
            icon = (
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="github h-full" viewBox="0 0 16 16">
        ...
        case "Resume":
            icon = (
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="file-person h-full" viewBox="0 0 16 16">
        ...
        case "Email":
            icon = (
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="envelope h-full" viewBox="0 0 16 16">
        ...
        case "Phone":
            icon = (
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="telephone h-full" viewBox="0 0 16 16">
        ...
        <aside className="flex flex-col w-[420px] h-full rounded-lg bg-spotify-grey">
            ...
            <div className="group/quicklinks flex-1">
                <div className="p-4 relative flex items-center overflow-hidden">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" className="link-angle h-5 text-light-grey absolute opacity-0 -translate-x-8 group-hover/quicklinks:opacity-100 group-hover/quicklinks:translate-x-0 transition-all duration-200 group-hover/quicklinks:delay-[50ms]">
            ...
            <div className="group/contactlinks text-light-grey pb-3">
                <div className="p-4 relative flex items-center overflow-hidden">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" className="people h-5 text-light-grey absolute opacity-0 -translate-x-8 group-hover/contactlinks:opacity-100 group-hover/contactlinks:translate-x-0 transition-all duration-200 group-hover/contactlinks:delay-[50ms]">
